<template>
  <div class="layout d-flex flex-column h-100">
    <topbar :refresh="true" :subtitle="'Daftar Return'" @refreshed="onRefresh" />
    ...
    <div class="row mt-3 mx-2 pb-2" style="height: 80% !important">
      ...
      <div class="col-9 card">
        <template v-if="selected">
          <div class="row mt-3">
            <div class="col text-right">
              <h4 class="text-primary">
                <strong>
                  {{ selected && selected.KodeKasirReturn }}
                </strong>
              </h4>
              <h6>
          ...
          <div v-for="(dt, index) in selected && selected.Items" :key="index" class="row" style="max-height: 45vh !important; overflow-y: scroll;">
            <div class="col">
              {{ dt.NamaItem }}
            </div>
            <div class="col text-right">
...
export default {
  ...
  data () {
    return {
      endpoint: 'item/fetchReturnTransaction',
      search: '',
      dateStart: null,
      dateEnd: null,
      page: 1,
