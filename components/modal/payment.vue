        ...
        <b-container class="mb-4">
          ...
          <div class="mt-3 text-left">
            ...
            <div class="row mt-2">
              ...
              <div class="col text-right">
                <label>
                  <input type="radio" value="yes" v-model="choice"> Ya
                </label>
                <label>
                  <input type="radio" value="no" v-model="choice"> Tidak
                </label>
              </div>
            </div>
            <inputNumber
  ...
  methods: {
    ...
    print () {
      ...
      product.forEach((element) => {
        const tempTotal = this.formatPrice(element.Qty * element.HargaJual)
        const tempName = element.NamaItem
        const tempQty = (element.Qty).toString()
        const tempPrice = this.formatPrice(element.HargaJual)
        console.log(product)
        // eslint-disable-next-line no-undef
        BTPrinter.printTextSizeAlign(function (data) {
        }, function (err) {
